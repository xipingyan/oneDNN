...
const impl_list_map_t &comp_bf16_s8_impl_list_map() {
    static const impl_list_map_t the_map = REG_REORDER_P({
        ...
        {{bf16, s8, 2}, {
            ...
            DNNL_NON_X64_ONLY(REG_SR(bf16, io, s8, OI4i16o4i, fmt_order_keep, spec_conv_req_comp))
            DNNL_NON_X64_ONLY(REG_SR(bf16, oi, s8, OI4i32o4i, fmt_order_keep, spec_conv_req_comp))
            DNNL_NON_X64_ONLY(REG_SR(bf16, io, s8, OI4i32o4i, fmt_order_keep, spec_conv_req_comp))
            DNNL_NON_X64_ONLY(REG_SR(bf16, oi, s8, OI4i64o4i, fmt_order_keep, spec_conv_req_comp))
            DNNL_NON_X64_ONLY(REG_SR(bf16, io, s8, OI4i64o4i, fmt_order_keep, spec_conv_req_comp))
